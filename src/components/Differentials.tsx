...
const ITEMS = [
  {
    ...
    text:
      "Jardins amplos, árvores centenárias e luz natural que dispensa cenários. Aqui a paisagem é parte do evento.",
    photo: photos[14],
  },
  {
    numeral: "II",
    ...
    text:
      "Salões com pé-direito alto, varandas em curva e detalhes em madeira que carregam a sofisticação de outra época.",
    photo: photos[16],
  },
  {
    numeral: "III",
    ...
    text:
      "Espaço dedicado para celebrações entre o verde, com infraestrutura completa para chuva ou sol pleno.",
    photo: photos[19],
  },
  {
    numeral: "IV",
    ...
    text:
      "A 130 km de São Paulo. Acesso fácil, clima ameno e o charme de uma cidade histórica para receber seus convidados.",
    photo: photos[26],
  },
  {
    numeral: "V",
    ...
    text:
      "Estrutura modular que abraça desde celebrações intimistas até festas grandiosas, sem perder a atmosfera acolhedora.",
    photo: photos[12],
  },
  {
    numeral: "VI",
    ...
    text:
      "Uma equipe que cuida dos detalhes do primeiro contato à última dança — para você só viver o seu dia.",
    photo: photos[5],
  },
];
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-6 lg:px-10">
        ...
        <div className="mt-24 flex flex-col items-center gap-3">
          <span
            className="font-serif text-3xl text-primary/60 leading-none select-none"
            aria-hidden
          >
            ❦
          </span>
...
function EditorialRow({
  ...
  return (
    ...
    >
      ...
      <div
        className={`md:col-span-6 [direction:ltr] ${
          reverse ? "md:pr-4 lg:pr-10" : "md:pl-4 lg:pl-10"
        }`}
      >
        <div className="flex items-center gap-4">
          ...
          <span className="text-xs tracking-[0.4em] uppercase text-ink-soft font-medium">
            Diferencial
          </span>
        </div>
        ...
        <p className="mt-6 text-ink-soft text-[1.05rem] leading-relaxed max-w-md">
          {item.text}
        </p>
