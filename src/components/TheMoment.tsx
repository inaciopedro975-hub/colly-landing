  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-12 gap-10 lg:gap-16 items-center">
        {/* COLUNA ESQUERDA — foto principal vertical, dramática */}
        <motion.div
        ...
        >
          {/* Numeração editorial sobreposta */}
          <span
            className="absolute -top-12 -left-2 lg:-left-8 font-serif text-[6rem] sm:text-[9rem] lg:text-[11rem] font-light text-primary/15 leading-none select-none"
            aria-hidden
          >
            01
          </span>
          ...
          <div className="relative aspect-[4/5] sm:aspect-[5/6] rounded-sm overflow-hidden shadow-[0_50px_140px_-30px_rgba(42,31,18,0.55)]">
            ...
            {/* Faixa dourada inferior com legenda */}
            <div className="absolute bottom-0 left-0 right-0 px-6 sm:px-10 py-4 sm:py-5 bg-gradient-to-t from-ink/80 to-transparent">
              <div className="flex items-center gap-4 text-white/95">
                ...
                <span className="font-script text-2xl sm:text-3xl text-primary-light leading-none">
                  o grande dia
                </span>
              </div>
            </div>
          ...
          {/* Foto secundária — sobreposta como polaroid */}
          <motion.div
            style={{ y: ySecondary }}
          ...
          >
            <div className="relative aspect-[3/4] overflow-hidden bg-cream">
              <Image
                src={SECONDARY_PHOTO.src}
                alt="Beijo sob arco floral à noite"
                fill
                sizes="288px"
                className="object-cover"
              />
        ...
        >
          <span className="block tracking-[0.5em] uppercase text-xs text-primary font-medium mb-8">
            ⸺ O Momento ⸺
          </span>
          <h2 className="font-serif text-4xl sm:text-5xl md:text-[3.4rem] leading-[1.05] font-light text-ink text-balance">
            Existe um instante
            <br />
            <span className="font-script text-primary text-5xl sm:text-6xl md:text-7xl leading-none">
              que muda tudo.
            </span>
          </h2>
          ...
          <div className="mt-10 space-y-5 text-ink-soft text-lg leading-relaxed text-pretty max-w-md">
            <p>
              É a sua mão na dele. As pétalas no ar. O sorriso de quem amou
              vocês a vida inteira.
            </p>
            <p className="italic text-ink-soft/80">
              É o momento em que tudo o que vocês imaginaram acontece de
              verdade. E nós cuidamos para que ele seja exatamente como deve
              ser — seu, inteiro, eterno.
            </p>
          </div>

          <div className="mt-12 flex items-center gap-5">
            <div className="h-px w-20 bg-primary" />
            <span className="font-script text-3xl text-primary leading-none">
              eternize aqui
            </span>
          </div>
          ...
          <a
            href="#agendar"
            className="mt-10 inline-flex items-center gap-3 text-ink hover:text-primary transition group"
          >
            <span className="text-sm tracking-[0.3em] uppercase font-semibold">
              Reservar uma data
            </span>
            <span className="w-10 h-10 rounded-full border border-ink/20 group-hover:border-primary group-hover:bg-primary group-hover:text-white flex items-center justify-center transition-all group-hover:translate-x-1">
              →
            </span>
          </a>
        </motion.div>
